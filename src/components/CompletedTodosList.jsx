...
const CompletedTodosList = (props) => {
    ...
    return (
        <section className="App-section">
            <header className="App-subheader">
                <h2 className="App-subtitle">
                    ...
                    <button className="btn btn-clean" onClick={() => {
                        ...
                        {grid ?
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 -960 960 960"><path d="M120-520v-320h320v320zm0 400v-320h320v320zm400-400v-320h320v320zm0 400v-320h320v320zM200-600h160v-160H200zm400 0h160v-160H600zm0 400h160v-160H600zm-400 0h160v-160H200zm160-400"/></svg>
                        :
            ...
            <ul className={`list-unstyled ${grid ? `is-grid` : ``}`}>
