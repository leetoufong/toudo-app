	...
	return (
		<form onSubmit={handleAddTodo} className="AddTodo form">
			...
			<div className="form-group">
				...
				<button className="AddTodo-btn btn" title="Add a to-do"><svg xmlns="http://www.w3.org/2000/svg" height="24" width="24"><path d="M0 0h24v24H0z" fill="none" /><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z" /></svg></button>
			</div>
